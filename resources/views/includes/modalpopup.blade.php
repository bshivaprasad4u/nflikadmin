            ...
            <div class="onboarding-slider-w">
                <div class="onboarding-slide">
                    <div class="onboarding-media">
                        <img alt="" src="{{ asset('template/img/bigicon2.png')}}" width="200px">
                    </div>
                ...
                <div class="onboarding-slide">
                    <div class="onboarding-media">
                        <img alt="" src="{{ asset('template/img/bigicon5.png')}}" width="200px">
                    </div>
                    <div class="onboarding-content with-gradient">
                        <h4 class="onboarding-title">
                ...
                <div class="onboarding-slide">
                    <div class="onboarding-media">
                        <img alt="" src="{{ asset('template/img/bigicon6.png')}}" width="200px">
                    </div>
                    <div class="onboarding-content with-gradient">
                        <h4 class="onboarding-title">
